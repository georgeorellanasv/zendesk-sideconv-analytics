...
<div style="background:#EBE5D7;padding:11px 24px;display:flex;gap:8px;flex-wrap:wrap;justify-content:center;border-bottom:1px solid rgba(20,20,19,.10)">
  ...
  <a href="daily_adherence.html" style="display:inline-block;padding:7px 15px;border-radius:6px;font-size:13px;font-weight:600;text-decoration:none;border:1px solid #CC785C;background:#CC785C;color:#fff"><span data-es>Dashboard Diario</span><span data-en>Daily Dashboard</span></a>
